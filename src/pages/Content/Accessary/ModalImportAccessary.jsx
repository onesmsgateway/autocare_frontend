...
import { getListAccessarys } from "../../../services/accessarys/accessarys";

export default function ModalImportAccessary({ currentPage, pageSize }) {
  ...
  const handleChange = async (info) => {
    ...
    if (info.file.status === "done") {
      setIsModalOpen(false);
      await store.dispatch(getListAccessarys({ currentPage, pageSize }));
    ...
    <div>
      ...
      >
        <Upload
          ...
          action={`${baseUrl}/company/api/v1/accessary-import`}
          headers={{
        ...
        <p style={{ margin: "10px 0" }}>
          ...
          <NavLink target="_blank" 
            rel="noopener noreferrer" to={`${baseUrl}/company/api/v1/accessary-excel`}>
            Tải
          </NavLink>
        </p>
      </Modal>
