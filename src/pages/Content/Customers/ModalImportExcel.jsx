...
export default function ModalImportExcel({ currentPage, pageSize }) {
    ...
    <div>
      ...
      >
        <Upload
          ...
          action={`${baseUrl}/customer/api/v1/customer-import`}
          headers={{
        ...
        <p style={{ margin: "10px 0" }}>
          ...
          <NavLink target="_blank" 
            rel="noopener noreferrer" to={`${baseUrl}/customer/api/v1/customer-excel`}>
            Tải
          </NavLink>
        </p>
      </Modal>
